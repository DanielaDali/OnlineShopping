...
<h3>Select Your New Securtiy Question</h3>
  	...
  	<option value="What is the name f your first pet?">What is the name of your first pet?</option>
  	<option value="What elementary school did you attend?">What elementary school did you attend?</option>
  	<option value="What the name of the town where you were born?">What the name of the town where you were born?</option>
  	</select>
 <hr>
